...
Supplementary utils for CRAN maintainers and R packages developers in the pacs package.
...
Think `tiny` and be minimalist for better UX and less development work.
