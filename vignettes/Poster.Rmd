...
```{nomnoml, fig.width=8, fig.height=4, svg=FALSE}
#stroke: black
#padding: 0
#spacing: 0
#fontSize: 12
...
- **NEWS**, checking the NEWS file to get last updates and their significance; `utils::news(package = "keras")`; e.g.  https://cran.r-project.org/package=keras/news/news.html.
...
```{nomnoml, fig.width=8, fig.height=3, svg=FALSE}
#stroke: black
#padding: 0
#spacing: 0
#fontSize: 12
