...
**Hint3**: Almost all time consuming calculations are cached (for 1 hour) with `memoise::memoise` package, and the second invoke of the same call is instantaneous.
